...
public class S3Access implements FileAccess {
	...
	public S3Access(Vertx vertx, URI uri, String accessKey, String secretKey, String region, String bucket) {
		client = new S3Client(vertx, uri, accessKey, secretKey, region, bucket);
	}
